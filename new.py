...
def imgPathDEF(count):
    ...
    for i in range(len(pathChanger)):
        if pathChanger[i] == '.':
            ...
            pathChanger[i-1] = b
    newPath = str() 
    appendVal = locationOFfile + newPath
    for i in range(len(pathChanger)):
        newPath += pathChanger[i]
    allimgPath.append(appendVal)
...
def genaratePIE(subject):
    pervalue = list()
    for i in range(len(subject)):
        pervalue.append(Percentage(subject[i]))
    till35 = 0
    till50 = 0
    till75 = 0
    till90 = 0
...
document.add_picture('matplotlibExample0.png',width=Inches(4.0), height=Inches(4.0))
document.add_paragraph('students failed \n')
for i in range(len(sub1fail)):
    document.add_paragraph(sub1pass[i])
document.add_page_break()

document.add_heading(subjects[1], level=1)
document.add_picture('matplotlibExample1.png',width=Inches(4.0), height=Inches(4.0))
document.add_paragraph('students failed \n')
for i in range(len(sub2fail)):
    document.add_paragraph(sub1pass[i])
document.add_page_break()

document.add_heading(subjects[2], level=1)
document.add_picture('matplotlibExample2.png',width=Inches(4.0), height=Inches(4.0))
document.add_paragraph('students failed \n')
for i in range(len(sub3fail)):
    document.add_paragraph(sub1pass[i])
document.add_page_break()

document.add_heading(subjects[3], level=1)
document.add_picture('matplotlibExample3.png',width=Inches(4.0), height=Inches(4.0))
document.add_paragraph('students failed \n')
for i in range(len(sub4fail)):
    document.add_paragraph(sub1pass[i])
document.add_page_break()

document.add_heading(subjects[4], level=1)
document.add_picture('matplotlibExample4.png',width=Inches(4.0), height=Inches(4.0))
document.add_paragraph('students failed \n')
for i in range(len(sub5fail)):
    document.add_paragraph(sub1pass[i])
document.add_page_break()

document.add_heading(subjects[5], level=1)
document.add_picture('matplotlibExample5.png',width=Inches(4.0), height=Inches(4.0))
document.add_paragraph('students failed \n')
for i in range(len(sub6fail)):
    document.add_paragraph(sub1pass[i])
document.add_page_break()
